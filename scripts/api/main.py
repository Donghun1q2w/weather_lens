...
from scripts.api.routes import health, themes, regions, feedback, internal, astronomy, photo_spots, user_collections, marine
from scripts.api.routes import map as map_routes
